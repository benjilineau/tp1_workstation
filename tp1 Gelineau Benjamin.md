...
* commande utilisée : "Get-WmiObject -Class Win32_Processor | Select-Object -Property Name, Number*"
```
...
*  commande utilisée :"diskpart" , "sel disk 0" puis "detail disk" 
...
* commande utilisée pour trouver les infos sur mes catres réseaux : "systeminfo"
```
[...]
...
```
* commande utilisée pour trouver les ports tcp et udp en utilisations et les applications qui les utilisent: "nestat -a -b"
